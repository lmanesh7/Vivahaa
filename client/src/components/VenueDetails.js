  ...
  const handleBooking = () => {
    if(!sessionStorage?.getItem('loggedInUser')){
     ...
     // <Link to="/booking" component={BookingForm} />
      window.location = `../booking/${'venue'}/${venue._id}`
      console.log(venue);
      return (
      <Link
  to={{
...
/>)
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Dialog
  open={openAllReviewsDialog}
  onClose={handleCloseAllReviewsDialog}
  maxWidth="md"
  fullWidth
>
  ...
  <DialogActions>
    <Button onClick={handleCloseAllReviewsDialog} color="primary">
      Close
    </Button>
  </DialogActions>
</Dialog>
