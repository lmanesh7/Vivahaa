...
const IndianWeddingTraditions = () => {
    return (
        <div>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>What to Expect at an Indian Wedding</h2>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Turmeric</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Mandap</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Agni (Sacred Fire)</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Jewelry</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Indian Wedding Colors</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>Hindu Wedding Traditions</h2>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>Jain Wedding Traditions</h2>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Ghudchadi</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Kanyavaran</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Sva Graha Aagamana</h3>
            <img src="https://media-api.xogrp.com/images/058b5ac1-3cb6-4d9a-9180-961449c1297e~rs_768.h" alt="Indian wedding traditions" />
            <p>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>Sikh Wedding Traditions</h2>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>Marathi Wedding Traditions</h2>
            <img src="https://media-api.xogrp.com/images/338b5b69-ba6d-4099-8da0-8775131a57f2~rs_768.h" alt="Indian wedding traditions" />
            <p>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>Bengali Wedding Traditions</h2>
            <img src="https://media-api.xogrp.com/images/6a9b91c4-9da2-430d-975c-4e5e2a5b71ea~rs_768.h" alt="Indian wedding traditions" />
            <p>
            ...
            {/* <image> */}
            <h2 style={{fontSize: '24px', fontWeight: 'bold'}}>South Indian Wedding Traditions</h2>
            <img src="https://media-api.xogrp.com/images/97ce6670-76ba-4ee2-90fe-e84a269a1f99~rs_768.h" alt="Indian wedding traditions" />
            <p>
            ...
            {/* <image> */}
            <h3 style={{fontSize: '20px', fontWeight: 'bold'}}>Andhra Pradesh Weddings</h3>
            {/* <image> */}
            <p>
            ...
            {/* <image> */}
            <h4 style={{fontSize: '18px', fontWeight: 'bold'}}>Telugu Weddings</h4>
            {/* <image> */}
            <p>
...
export default IndianWeddingTraditions;
